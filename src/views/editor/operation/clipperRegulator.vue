<template>
    <div class='item-list' >
            ...
            <div class='item' @mousedown.stop="controlshape('left-down')" :style="{ 
             ...
             <div class='item' @mousedown.stop="controlshape('right-top')" :style="{ 
             ...
             <div class='item' @mousedown.stop="controlshape('right-down')" :style="{ 
...
export default defineComponent({
    ...
    setup (props,{emit}) {
        ...
        const controlshape=(direction:string)=>{
            ...
            let oriShowTop = module.value.showTop
            let oriShowLeft = module.value.showLeft
            let showWidth = module.value.showWidth
            let showHeigth = module.value.showHeigth
            if(direction == 'right-down'){
                    ...
                    window.onmousemove = (event:MouseEvent)=>{
                        ...
                        module.value.left = module.value.left + (module.value.height-height)*sin/2
                        module.value.top = module.value.top - (module.value.height-height)*(1+cos)/2 
                        module.value.showTop = oriShowTop - module.value.height + height
                     }
                    ...
                    window.onmousemove = (event:MouseEvent)=>{
                        ...
                        module.value.top = module.value.top - (module.value.height-height)*(1+cos)/2 
                        module.value.showTop = oriShowTop - module.value.height + height
                        module.value.showLeft = oriShowLeft - module.value.width + width
