<template>
  <div class='chart-content'  @click='selectModel'  @mousedown="moduleMove(module)" :style="{  width: module.width + 'px'
...
export default defineComponent({
  ...
  setup (props) {
    ...
    watch(()=>{return module.value.width},(nv,ov)=>{
      draw()
    })
    watch(()=>{return module.value.height},(nv,ov)=>{
      draw()
    })
